function NNtrain()
    ...
    % Wyświetlenie wyuczonych parametrów
    ...
    % Uruchomienie oryginalnego kodu z wyuczonymi parametrami
    % (Tutaj dodajemy kod uruchamiający oryginalny kod z wyuczonymi parametrami)
